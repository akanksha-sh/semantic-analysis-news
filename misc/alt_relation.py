# Obsolete approaches - DO NOT RUN
import spacy
from spacy.matcher import Matcher
from dataProcessing import get_entities
from relationExtraction import filter_triples
        ...
        for token in sent:
            ...
            if subject:
                ...
                if relation:
                    ...
                    if relation.i < len(sent) - 1 and relation.nbor(1).pos_ in (
                        "ADP",
                        "PART",
                    ):
